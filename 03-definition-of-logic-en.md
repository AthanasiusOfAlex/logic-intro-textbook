...
We have already laid the necessary groundwork. In fact, you should already be able to explain what it means for logic to be an *instrumentally speculative and modally practical* science. By the end of this chapter, you should have a good understanding of what logic actually is.
...
Now that we have established what logic actually is, I can say somethings about how the course is organized. The works of reason—concepts, enunciations, and arguments—constitute the material object of logic, as we saw, and for this reason we divide classical logic into three main chapters: the logic of the concept, the logic of the enunciation, and the logic of the argument or syllogism.
