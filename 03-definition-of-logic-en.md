...
[^formal-object-quo]: In Latin, the *obiectum formale quo*; literally, the “formal objet *by which*” we see.
...
We call concepts that refer *immediately* to real entities *first intentions*. On the other hand, concepts that refer to some work of our reason, we call *second intentions*. Note that even second intentions refer to reality in a *mediate* or indirect way: for instance, when I take the term “human being” to mean the *concept* formed in my reason, that concept refers in the first place to the *concept*—but of course that concept, in turn, refers to real human beings. I will let Aquinas speak here:
